            ...
            switch (option) {
                case 1:
                    ...
                    try {
                        ...
                        System.out.println("");
                        trace = new Trace("B", "getTitlesByAuthor", authorName, new Date());
                        trace.guardarTraza();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                ...
                case 2:
                    ...
                    try {
                        IBooksService booksService = (IBooksService) Naming.lookup(Constants.URL);
                        booksViews.printBook(booksService.getTitleByName(authorName2));
                        System.out.println("");
                        trace = new Trace("B", "getTitleByName", authorName2, new Date());
                        trace.guardarTraza();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
